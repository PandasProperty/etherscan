...
const fetchGasPrices = async (abortController: AbortController): Promise<Status<GasPrices>> => {
...
const fetchEtherPrice = async (abortController: AbortController): Promise<Status<EtherPrice>> => {
  const searchParams = new URLSearchParams();
